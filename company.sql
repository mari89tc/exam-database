...
CREATE TABLE menu_items(
    menu_item_pk            CHAR(36), --UNIQUE is not necessary
...
-- Adjusted with consistent UUIDs and mapping
INSERT INTO restaurants_owners VALUES ("ea793097-bf74-4434-b506-024fbe1ad680", "883d66a9-695e-48b8-856c-89936789d2a4"); -- User B owns Lulu's Diner
INSERT INTO restaurants_owners VALUES ("6d289cb7-7701-4296-b49e-641d39f6c5a7", "6a44aa2c-08c2-4b0e-ae2f-6e10669cd6f8"); -- User D owns Bean the Bean
INSERT INTO restaurants_owners VALUES ("6d289cb7-7701-4296-b49e-641d39f6c5a7", "883d66a9-695e-48b8-856c-89936789d2a4"); -- User D also owns Lulu's Diner
...
-- Adjusted with consistent UUIDs and timestamps
...
-- Adjusted with consistent UUIDs and realistic mappings
INSERT INTO orders_details VALUES ("a1c35f00-8d47-4d3b-bf80-b87a3fdf14c1", "1", 2); -- Order A1 includes carrot salad
INSERT INTO orders_details VALUES ("a1c35f00-8d47-4d3b-bf80-b87a3fdf14c1", "2", 1); -- Order A1 includes cucumber drink
INSERT INTO orders_details VALUES ("b6d45e11-c234-41f9-b6e5-84f33d2a44f1", "3", 3); -- Order B6 includes bean salad
INSERT INTO orders_details VALUES ("c2d56712-d125-4e4a-a634-7dc73f2035c9", "4", 1); -- Order C2 includes burger
INSERT INTO orders_details VALUES ("d3f67813-e126-4e5b-b734-9fc84f4146d0", "5", 2); -- Order D3 includes fries
...
--UPDATED SQL STATEMENTS USED FOR PHPMYADMIN
-- DROP TABLE IF EXISTS restaurants_owners;
-- DROP TABLE IF EXISTS orders_details;
-- DROP TABLE IF EXISTS orders;
-- DROP TABLE IF EXISTS menu_items;
...
--     FOREIGN KEY(user_fk) REFERENCES users(user_pk) ON DELETE CASCADE
-- );
-- INSERT INTO phone_numbers VALUES ("73128322", "8a505c5d-f7c0-4cbe-9e97-16e7ef6cfd60");
-- INSERT INTO phone_numbers VALUES ("76332873", "ea793097-bf74-4434-b506-024fbe1ad680");
-- INSERT INTO phone_numbers VALUES ("76221873", "7cb9bf5d-eeb7-4f1a-b837-3621415285a0");
-- INSERT INTO phone_numbers VALUES ("76342873", "6d289cb7-7701-4296-b49e-641d39f6c5a7");
